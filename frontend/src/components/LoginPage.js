				...
				{!isCreatingAccount ? (
					<div className='heading1'>
						...
						<center>
							<div style={{ width: '35%', height: '20%' }}>
								...
								<button onClick={createAccount} className='btn btn-primary mx-auto'>
									Create an Account
								</button>
							</div>
						</center>
						<br />
						<button onClick={continueAsGuest} className='btn btn-primary mx-auto'>
							Continue as Guest
						</button>
						<br />
						<br />
					...
					<div id='createAccountForm'>
						<div className='container' style={{ width: '100%', display: 'block' }}>
							...
							<div>
								<center>
									<button onClick={makeAccount} className='btn btn-primary mx-auto'>
										Create Account
									</button>
								</center>
							</div>
