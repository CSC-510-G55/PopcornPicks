...
const Landing = () => {
  ...
  return (
    <div className="landing-page">
      <nav
        className="navbar navbar-expand-lg navbar-dark bg-dark topNavBar fixed-top"
        id="landingTopNav"
      >
      ...
      <div className="container" id="centralDivLanding">
        <div className="heading1">
          ...
          <p className="text-center text-light">
            Discover personalized movie recommendations by selecting up to 5 of
            your favorite films.
            <br />
          ...
          <div className="highlighted-section text-center">
            <p>
              Made with ❤️ by{" "}
              <a
                href="https://github.com/Shrimadh/PopcornPicks"
                target="_blank"
