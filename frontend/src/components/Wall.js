    ...
    <div>
      ...
      <div className="container" style={{marginTop: '900px'}}>
        <div className="heading1">
          ...
          <button id="backToLanding" onClick={backToLandingPage} className="btn btn-primary mx-auto">Return home</button>
        </div>
      </div>
...
const Post = ({ post, fetchMovieData, renderStars }) => {
  ...
  <div className="row g-0">
    <div className="col-md-3 col-lg-2">
      <img src={movieData.Poster} alt={movieData.Title} className="img-fluid rounded-start" style={{maxHeight: '200px', objectFit: 'cover'}} />
    </div>
