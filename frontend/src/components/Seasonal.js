			...
			<div className='holiday-buttons text-center'>
				...
				{isWithinHolidayRange(newYearsDay, currentDate) && (
					<button
						...
						onClick={() => window.open('https://www.imdb.com/list/ls522631204/', '_blank')}
					>
				...
				{isWithinHolidayRange(independenceDay, currentDate) && (
					<button
						...
						onClick={() => window.open('https://www.imdb.com/list/ls528659350/', '_blank')}
					>
				...
				{isWithinHolidayRange(thanksgivingDay, currentDate) && (
					<button
						...
						onClick={() => window.open('https://www.imdb.com/list/ls000835734/', '_blank')}
					>
				...
				{isWithinHolidayRange(laborDay, currentDate) && (
					<button
						...
						onClick={() => window.open('https://www.imdb.com/list/ls002014923/', '_blank')}
					>
				...
				{isWithinHolidayRange(memorialDay, currentDate) && (
					<button
						...
						onClick={() => window.open('https://www.imdb.com/list/ls561621160/', '_blank')}
					>
